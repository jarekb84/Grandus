...
*   **Mechanics:**
    ...
    *   **Hex Interaction & Strategic Actions:**
        ...
        *   **Info Panel (Adjacent, Uncontrolled Hex):** Shows limited scouted info (if any), potential resource types (maybe?), estimated difficulty baseline. Provides an **`Expand Combat`** button.
