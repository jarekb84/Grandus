...
Visually represent the initial, single Stone resource node centered within the player's home hex.

---

## Initial Acceptance Criteria (Optional Placeholder)

*   [Placeholder: The initial Stone resource node entity is visible on the Territory View map.]
*   [Placeholder: The Stone node entity is positioned visually within the boundaries of the designated starting hex (same as Home Base).]
*   [Placeholder: The Stone node entity appears centered (or appropriately positioned according to design) within the hex.]

---

## Notes / Context

*   This story focuses solely on the visual placement based on hex coordinates. Mechanics (capacity, respawn) are handled in subsequent stories.
