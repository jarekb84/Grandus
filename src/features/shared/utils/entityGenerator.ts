...
const RESOURCE_NODE_CONFIGS = {
  ...
  [ResourceNodeType.IRON_DEPOSIT]: {
    ...
    yields: [
      { resourceType: ResourceType.STONE, baseAmount: 1, chance: 1 },
      { resourceType: ResourceType.STONE, baseAmount: 2, chance: 0.1 } // Bonus stone chance
    ],
    gatheringProperties: {
      baseGatherTime: 1500,
  ...
  [ResourceNodeType.BERRY_BUSH]: {
    ...
    shape: Shape.CIRCLE,
    yields: [
      { resourceType: ResourceType.FOOD, baseAmount: 1, chance: 1 }
    ],
    gatheringProperties: {
      baseGatherTime: 800,
  ...
  [ResourceNodeType.FALLEN_BRANCHES]: {
    ...
    shape: Shape.SQUARE,
    yields: [
      { resourceType: ResourceType.WOOD, baseAmount: 1, chance: 1 }
    ],
    gatheringProperties: {
      baseGatherTime: 600,
  ...
  [ResourceNodeType.TREE]: {
    ...
    yields: [
      ...
      { resourceType: ResourceType.FOOD, baseAmount: 1, chance: 0.2 } // Small chance of food (fruits)
    ],
    gatheringProperties: {
      baseGatherTime: 2000,
